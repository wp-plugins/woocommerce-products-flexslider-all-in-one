            ...
            jQuery(document).ready(function() {
                jQuery(window).load(function() {
                    jQuery(".woocommerce-products-flexslider-'.$params['id'].'").flexslider({
                        ...
                        slideDirection: "'. ( array_key_exists('slide_direction', $params) ? $params['slide_direction'] : 'horizontal' ).'", 
                        slideshowSpeed: '.( array_key_exists('slide_speed', $params) ? $params['slide_speed'] : 4000 ).', 
